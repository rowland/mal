...
DATA-07: English grading accepts top-level comma- and semicolon-separated meanings and optional leading infinitive “to ” for predicates; accept omission of balanced parenthetical hints while preserving the displayed full definition; do not split delimiters inside parentheses/brackets. Parenthetical omission applies to English answers, not English-to-Korean sense equivalence. English personal aliases can be saved in any Korean form category, with shared grading/distractor exclusion semantics.
...
DATA-08: Identical bare English meanings with no sense cue accept corresponding curated Korean answers across grammatical categories and installed banks, filtered per candidate to the selected form style. Explicitly cued prompts require matching cue and part of speech. Adjective “be X” and “X” are equivalent wording. Show other valid focused Korean forms in introductions/corrections; keep progress per presented sense.
